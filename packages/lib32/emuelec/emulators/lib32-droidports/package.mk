...
# NextOS-Elite-Edition: GMLoader com Multilib Support (Fim do LD_PRELOAD)
...
PKG_CMAKE_OPTS_TARGET=" \
 ...
 -DPLATFORM=linux \
 -DPORT=gmloader \
 -DUSE_BUILTIN_FREETYPE=ON \
 -DCMAKE_POLICY_VERSION_MINIMUM=3.5 \
 -DCMAKE_INSTALL_RPATH=/usr/lib32:/usr/config/emuelec/configs/gmloader \
...
post_make_target() {
  patchelf --add-needed libMali.so ${PKG_BUILD}/.${TARGET_NAME}/gmloader || true
  patchelf --set-rpath /usr/lib32 ${PKG_BUILD}/.${TARGET_NAME}/gmloader || true
}
