...
if [ "${PROJECT}" = "Amlogic-ce" ]; then
  PKG_CMAKE_OPTS_TARGET="-DNOX11=1 -DODROID=1 -DCMAKE_POLICY_VERSION_MINIMUM=3.5 -DGBM=OFF -DCMAKE_BUILD_TYPE=Release"
else
  PKG_CMAKE_OPTS_TARGET="-DNOX11=1 -DODROID=1 -DCMAKE_POLICY_VERSION_MINIMUM=3.5 -DGBM=ON -DCMAKE_BUILD_TYPE=Release"
fi
