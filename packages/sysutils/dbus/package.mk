...
# ✔ Mantemos suas dependências, mas adicionamos o host para o build Meson
...
# ✔ Configurações Meson otimizadas para o seu hardware antigo
...
post_makeinstall_target() {
  # ✔ Limpeza de arquivos de desenvolvimento que não rodam no TV Box
  rm -rf ${INSTALL}/etc/rc.d
  rm -rf ${INSTALL}/usr/lib/dbus-1.0/include
}

post_install() {
  # ✔ Seus comandos de permissão e usuários originais (Essenciais para o Boot)
