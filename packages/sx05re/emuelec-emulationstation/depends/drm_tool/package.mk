...
pre_configure_target() {
  # Adicionamos -I${SYSROOT_PREFIX}/usr/include/libdrm para ele achar o drm.h
  export CFLAGS="${TARGET_CFLAGS} -D_FILE_OFFSET_BITS=64 -I${SYSROOT_PREFIX}/usr/include/libdrm"
