...
make_target() {
  ...
  cp ${PKG_BUILD}/projects/unix/mupen64plus-rsp-hle.so \
     ${PKG_BUILD}/projects/unix/mupen64plus-rsp-hle-base.so
  ...
  case ${DEVICE} in
    AMD64|RK3588|S922X|RK3399)
      ...
      make -C projects/unix all ${PKG_MAKE_OPTS_TARGET}
      cp ${PKG_BUILD}/projects/unix/mupen64plus-rsp-hle.so \
         ${PKG_BUILD}/projects/unix/mupen64plus-rsp-hle-simple.so
    ;;
  esac
}
...
makeinstall_target() {
  ...
  cp ${PKG_BUILD}/projects/unix/mupen64plus-rsp-hle-base.so \
     ${ULIBDIR}/mupen64plus-rsp-hle.so
  chmod 0644 ${ULIBDIR}/mupen64plus-rsp-hle.so

  if [ -e "${PKG_BUILD}/projects/unix/mupen64plus-rsp-hle-simple.so" ]
  then
    cp ${PKG_BUILD}/projects/unix/mupen64plus-rsp-hle-simple.so \
       ${ULIBDIR}
    chmod 0644 ${ULIBDIR}/mupen64plus-rsp-hle-simple.so
  fi
}