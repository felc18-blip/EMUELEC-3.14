...
make_target() {
  ...
  cp ${PKG_BUILD}/projects/unix/mupen64plus-rsp-cxd4${SUFFIX}.so \
     ${PKG_BUILD}/projects/unix/mupen64plus-rsp-cxd4-base.so
  ...
  case ${DEVICE} in
    AMD64|RK3588|S922X|RK3399)
      ...
      make -C projects/unix all ${PKG_MAKE_OPTS_TARGET}
      cp ${PKG_BUILD}/projects/unix/mupen64plus-rsp-cxd4${SUFFIX}.so \
         ${PKG_BUILD}/projects/unix/mupen64plus-rsp-cxd4-simple.so
    ;;
  esac
}
...
makeinstall_target() {
  ...
  cp ${PKG_BUILD}/projects/unix/mupen64plus-rsp-cxd4-base.so \
     ${ULIBDIR}/mupen64plus-rsp-cxd4.so
  chmod 0644 ${ULIBDIR}/mupen64plus-rsp-cxd4.so

  if [ -e "${PKG_BUILD}/projects/unix/mupen64plus-rsp-cxd4-simple.so" ]
  then
    cp ${PKG_BUILD}/projects/unix/mupen64plus-rsp-cxd4-simple.so \
       ${ULIBDIR}
    chmod 0644 ${ULIBDIR}/mupen64plus-rsp-cxd4-simple.so
  fi
}