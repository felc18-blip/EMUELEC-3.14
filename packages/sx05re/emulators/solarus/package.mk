...
pre_configure_target() {
  export LDFLAGS+=" -ldl"
  export CXXFLAGS+=" -DGLM_ENABLE_EXPERIMENTAL"

  PKG_CMAKE_OPTS_TARGET="-DSOLARUS_GL_ES=ON -DSOLARUS_GUI=OFF -DSOLARUS_USE_LUAJIT=ON -DSOLARUS_TESTS=OFF -DCMAKE_POLICY_VERSION_MINIMUM=3.5"
}
