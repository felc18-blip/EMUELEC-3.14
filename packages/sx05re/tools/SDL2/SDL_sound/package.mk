...
pre_configure_target() {
  # Força o GCC 15 a ignorar as "sujeiras" do código antigo do mpg123
  export CFLAGS="${CFLAGS} -Wno-error=implicit-function-declaration -Wno-error=attributes -Wno-error=array-bounds -Wno-error=stringop-overflow -Wno-error=incompatible-pointer-types"

  # Adiciona a linkagem da biblioteca matemática
